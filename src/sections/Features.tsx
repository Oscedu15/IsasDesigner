            ...
            <div className="container">
                ...
                >
                    ...
                    <FeatureCard
                        ...
                        description=" Powerfull commands to help you create designs
                                more quickly."
                    ...
                    >
                        <div className="aspect-video flex items-center gap-4 justify-center">
                            <Key className="w-28 outline group-hover:outline outline-transparent group-hover:outline-lime-400 transition-all duration-500 outline-2 outline-offset-4 group-hover:translate-y-1">
                                shift
                            </Key>
                            <Key className="outline group-hover:outline outline-transparent group-hover:outline-lime-400  transition-all duration-500 outline-2 outline-offset-4 group-hover:translate-y-1 delay-150">
                                alt
                            </Key>
                            <Key className="outline group-hover:outline outline-transparent group-hover:outline-lime-400  transition-all duration-500 outline-2 outline-offset-4 group-hover:translate-y-1 delay-300">
                                C
                            </Key>
                        </div>
                    </FeatureCard>
